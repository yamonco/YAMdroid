          ...
          {#each $scrcpySessions as session}
            <div class="bg-zinc-800 rounded-lg p-4 flex flex-col gap-2 border border-zinc-700 shadow">
              <div class="flex items-center justify-between">
                ...
                <button class="px-3 py-1 rounded bg-gray-700 text-xs text-white ml-2 border border-gray-500 hover:bg-gray-600 transition" onclick={() => toggleSessionForeground(session)}>
