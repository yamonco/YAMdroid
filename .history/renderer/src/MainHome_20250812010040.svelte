...
<!-- Svelte 템플릿 -->
<div class="min-h-screen flex flex-col bg-zinc-950 text-zinc-200 px-0 overflow-hidden" style="overflow:hidden;">
  <div class="flex-1 w-full flex flex-col items-center overflow-y-auto" style="max-height:calc(100vh-56px);">
    <div class="w-full max-w-lg mx-auto bg-zinc-900 rounded-xl shadow-lg p-8 border border-zinc-800 flex flex-col items-center flex-shrink-0">
      {#if loading}
