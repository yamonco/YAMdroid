  ...
  <div>
    ...
    <div class="flex flex-wrap gap-6">
      <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
        <Checkbox checked={usb} onChange={e => onChange('usb', e.target.checked)} />
        USB 연결
      </label>
      <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
        <Checkbox checked={tcpip} onChange={e => onChange('tcpip', e.target.checked)} />
        TCP/IP 연결
      </label>
      <label class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
        <Checkbox checked={forceAdb} onChange={e => onChange('forceAdb', e.target.checked)} />
        adb forward 강제
      </label>
    </div>
  </div>
