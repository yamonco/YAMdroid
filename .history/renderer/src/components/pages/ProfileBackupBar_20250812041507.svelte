...
<div class="flex gap-2 my-4">
  <div class="flex flex-col">
    <label class="text-xs mb-1">프로필 내보내기(백업)</label>
    <input class="input input-bordered input-sm" placeholder="경로/파일명.json" bind:value={exportPath} />
  ...
  <div class="flex flex-col">
    <label class="text-xs mb-1">프로필 불러오기(복구)</label>
    <input class="input input-bordered input-sm" placeholder="경로/파일명.json" bind:value={importPath} />
