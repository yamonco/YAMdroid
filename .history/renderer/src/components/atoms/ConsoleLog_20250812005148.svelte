...
{#if show}
<div class="w-full shadow-2xl rounded-t-xl border border-zinc-700 bg-zinc-950 text-zinc-200 flex flex-col min-w-[320px] max-w-[100vw]" style="margin:0 auto;{minimized ? 'height:40px' : 'height:320px'};">
  <!-- 드래그바 -->
  <div class="flex items-center justify-between cursor-move bg-zinc-900 rounded-t-xl px-3 py-2 select-none" on:mousedown={onDragStart} role="toolbar">
