        ...
        <section class="w-full flex flex-col gap-2 mb-4">
          <div class="flex items-center gap-2 mb-1">
            <span class="font-semibold text-sm">프로필 목록</span>
              <input class="px-2 py-1 rounded bg-zinc-800 border border-zinc-700 text-xs w-28" placeholder="새 프로필명" value={newProfileName} oninput={e => (newProfileName = e.target.value)} onkeydown={e => e.key === 'Enter' && addProfile()} />
